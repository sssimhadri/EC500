...
def main():
	...
	twitterHandles = ["katyperry", "justinbieber", "barackobama",
                  ...
                  "TheEllenShow", "Cristiano", "YouTube",
                  "jtimberlake", "Twitter", "KimKardashian","britneyspears",
                  "ArianaGrande", "ddlovato", "selenagomez", "cnnbrk",
                  "realDonaldTrump", "shakira", "jimmyfallon", "BillGates"]

	
    for handle in twitterHandles:
		outtweets = get_tweets(handle)
		download_images(outtweets)
		create_video()
		labels = analysis()
		data = {
